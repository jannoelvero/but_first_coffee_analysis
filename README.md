...
1.  **Competitive Pricing** --- determine how BFC's pricing compares
    with Starbucks Philippines and The Coffee Bean & Tea Leaf
    Philippines using directly comparable products.
2.  **Promotion Economics** --- evaluate the unit-volume response
    required for discounts to maintain revenue.
3.  **Customer Experience** --- identify the customer-experience
    dimensions most frequently mentioned in collected reviews.
4.  **Revenue Opportunities** --- translate external evidence into
...
1.  **Statistical evidence** --- matched-family Friedman test
2.  **Observed quantitative evidence** --- menu prices and observed
    promotion coverage
3.  **Descriptive customer evidence** --- review themes and management
    dimensions
4.  **Scenario analysis** --- pricing, promotion, and basket-response
    calculations
5.  **Management hypotheses** --- actions requiring internal validation
